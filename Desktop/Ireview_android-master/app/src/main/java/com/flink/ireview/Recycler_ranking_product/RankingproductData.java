...
public class RankingproductData {
    ...
    public RankingproductData(String ranking_item_number, int ranking_item_image, String ranking_item_company, String ranking_item_name) {
